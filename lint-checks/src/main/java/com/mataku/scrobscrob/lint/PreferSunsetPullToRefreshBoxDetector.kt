...
class PreferSunsetPullToRefreshBoxDetector : Detector(), SourceCodeScanner {
  ...
  private fun check(context: JavaContext, node: UImportStatement) {
    ...
    context.report(
      ...
      message = "Use `com.mataku.scrobscrob.ui_common.component.designsystem.SunsetPullToRefreshBox` instead of `androidx.compose.material3.pulltorefresh.PullToRefreshBox`.",
    )
  }
  ...
  companion object {
    ...
    val ISSUE: Issue = Issue.create(
      ...
      explanation = """
        ...
        `com.mataku.scrobscrob.ui_common.component.designsystem.SunsetPullToRefreshBox` wrapper over \
