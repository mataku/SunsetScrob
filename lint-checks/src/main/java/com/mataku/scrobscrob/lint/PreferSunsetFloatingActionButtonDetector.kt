...
class PreferSunsetFloatingActionButtonDetector : Detector(), SourceCodeScanner {
  ...
  private fun check(context: JavaContext, node: UImportStatement) {
    ...
    context.report(
      ...
      message = "Use `com.mataku.scrobscrob.ui_common.SunsetFloatingActionButton` instead of `$fqn`.",
    )
  }
  ...
  companion object {
    ...
    val ISSUE: Issue = Issue.create(
      ...
      explanation = """
        ...
        `com.mataku.scrobscrob.ui_common.SunsetFloatingActionButton` wrapper over \
