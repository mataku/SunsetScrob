...
class PreferSunsetIconButtonDetector : Detector(), SourceCodeScanner {
  ...
  private fun check(context: JavaContext, node: UImportStatement) {
    ...
    context.report(
      ...
      message = "Use `com.mataku.scrobscrob.ui_common.component.designsystem.SunsetIconButton` instead of `androidx.compose.material3.IconButton`.",
    )
  }
  ...
  companion object {
    ...
    val ISSUE: Issue = Issue.create(
      ...
      explanation = """
        Outside of `:ui_common`, prefer the `com.mataku.scrobscrob.ui_common.component.designsystem.SunsetIconButton` \
