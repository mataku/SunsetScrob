...
class PreferSunsetSurfaceDetector : Detector(), SourceCodeScanner {
  ...
  private fun check(context: JavaContext, node: UImportStatement) {
    ...
    context.report(
      ...
      message = "Use `com.mataku.scrobscrob.ui_common.SunsetSurface` instead of `androidx.compose.material3.Surface`.",
    )
  }
  ...
  companion object {
    ...
    val ISSUE: Issue = Issue.create(
      ...
      explanation = """
        Outside of `:ui_common`, prefer the `com.mataku.scrobscrob.ui_common.SunsetSurface` \
