...
Closing the sheet without authorizing delivers nothing: the launcher has no cancel signal, and the login screen simply stays put. Auth Tab (`AuthTabIntent`) was dropped because it has no partial-height API.
